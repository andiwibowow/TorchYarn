 ...
 * This file demonstrates how to integrate Torchyarn with a web frontend
 */

// For React/Vue/Angular applications
export class TorchyarnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TorchyarnClient(provider, contractAddress);
